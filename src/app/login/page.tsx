      ...
      >
        ...
        <div className="card p-8 bg-white">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold mb-2">Sign in to BillDrop</h1>
            <p className="text-[var(--foreground-muted)]">
              Connect your email to find hidden subscriptions
            </p>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 p-4 rounded-xl border-2 border-black/10 hover:border-[var(--accent-primary)] hover:bg-[var(--accent-primary)]/5 transition-all mb-4"
          >
          ...
          <p className="mt-6 text-center text-xs text-[var(--foreground-muted)]">
            We&apos;ll only read your email receipts to find subscriptions.<br/>
            No passwords stored. Revoke access anytime.
          </p>
        </div>
